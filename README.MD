...
```ts
addSubEntityToEntityById('shoppingCartItems', shoppingCartItem, ShoppingCart, { userAccountId });
```
...
```ts
addSubEntityToEntityById('shoppingCartItems', shoppingCartItems, ShoppingCart, { userAccountId });
```
