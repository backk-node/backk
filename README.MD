...
To use Default JWT authorization service, instantiate JwtAuthorizationServiceImpl class and store it as a field in your `MicroserviceImpl` class:
...
#### StartupCheckService and StartupCheckServiceImpl
