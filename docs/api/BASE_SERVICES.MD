...
```typescript
import { BACKK_ERRORS, HttpStatusCodes } from 'backk';
...
Instantiate the Backk default `StartupCheckServiceImpl` class or your own class and store it as a field in your `MicroserviceImpl` class:
