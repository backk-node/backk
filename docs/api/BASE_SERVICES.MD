...
Implement a `ResponseCacheConfigServiceImpl` class that extends the `ResponseCacheConfigService` class and provide implementations for the needed functions:
