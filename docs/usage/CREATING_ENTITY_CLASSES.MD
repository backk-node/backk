...
which are managed by sales item and order service, respectively. So user account service does not create
any table structures neither for `OwnSalesItem` nor `Order`.
