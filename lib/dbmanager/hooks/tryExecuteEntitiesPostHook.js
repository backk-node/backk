...
async function tryExecuteEntitiesPostHook(postHook, entities) {
    var _a, _b;
    ...
    try {
        if (typeof postHook === 'object' && postHook.executePostHookIf) {
            if (postHook.executePostHookIf(entities !== null && entities !== void 0 ? entities : null)) {
                hookCallResult = await postHookFunc(entities !== null && entities !== void 0 ? entities : null);
            }
        }
        else {
            hookCallResult = await postHookFunc(entities !== null && entities !== void 0 ? entities : null);
...
exports.default = tryExecuteEntitiesPostHook;
//# sourceMappingURL=tryExecuteEntitiesPostHook.js.map