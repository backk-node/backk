...
async function addFieldValues(dbManager, _id, fieldName, fieldValues, EntityClass, options) {
    var _a;
    ...
    try {
        ...
        promises.push(forEachAsyncParallel_1.default(fieldValues, async (fieldValue) => {
            const insertStatement = `INSERT INTO ${dbManager.schema.toLowerCase()}.${EntityClass.name.toLowerCase() +
                ...
                .slice(0, -1)
                .toLowerCase()}) VALUES(${currentEntity[fieldName].length}, ${dbManager.getValuePlaceholder(1)}, ${dbManager.getValuePlaceholder(2)})`;
...
exports.default = addFieldValues;
//# sourceMappingURL=addFieldValues.js.map