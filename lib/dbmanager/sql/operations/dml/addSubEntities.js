...
async function addSubEntities(dbManager, _id, subEntityPath, newSubEntities, EntityClass, options) {
    var _a;
    ...
    try {
        ...
        let [currentEntity, error] = await getEntityById_1.default(dbManager, _id, EntityClass, { postQueryOperations: options === null || options === void 0 ? void 0 : options.postQueryOperations }, true, true);
...
exports.default = addSubEntities;
//# sourceMappingURL=addSubEntities.js.map