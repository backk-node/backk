...
class DefaultPostQueryOperations {
    constructor() {
...
__decorate([
    ...
    MaxLengthAndMatches_1.default(constants_1.Lengths._512, /^[a-zA-Z_]([a-zA-Z0-9_.])+$/, { each: true }, true),
    class_validator_1.IsArray(),
    class_validator_1.ArrayMinSize(0),
    class_validator_1.ArrayMaxSize(constants_1.Values._500),
    class_validator_1.ArrayUnique(),
    __metadata("design:type", Array)
], DefaultPostQueryOperations.prototype, "includeResponseFields", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsString({ each: true }),
    MaxLengthAndMatches_1.default(constants_1.Lengths._512, /^[a-zA-Z_]([a-zA-Z0-9_.])+$/, { each: true }, true),
    ...
    class_validator_1.ArrayUnique(),
    __metadata("design:type", Array)
], DefaultPostQueryOperations.prototype, "excludeResponseFields", void 0);
__decorate([
    class_validator_1.IsOptional(),
    ...
    __metadata("design:type", Array)
], DefaultPostQueryOperations.prototype, "sortBys", void 0);
__decorate([
    class_validator_1.IsOptional(),
    ...
    class_validator_1.ArrayMaxSize(constants_1.Values._25),
    __metadata("design:type", Array)
], DefaultPostQueryOperations.prototype, "paginations", void 0);
exports.default = DefaultPostQueryOperations;
